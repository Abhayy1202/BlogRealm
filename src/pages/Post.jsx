...
export default function Post() {
    ...
    return post?(
      <section id="posts" className="py-20 bg-neutral-100 dark:bg-neutral-900 overflow-hidden">
        ...
        <div
          className="max-w-7xl bg-white dark:bg-neutral-800 rounded-lg shadow-lg overflow-hidden transform hover:-translate-y-1 transition-transform duration-300 animate__animated animate__fadeInUp mx-auto px-4 sm:px-6 lg:px-8 relative z-10"
          id="el-nmxkhpr9"
        >
          <div
            className="text-3xl font-bold text-center mb-11 pt-4 text-neutral-800 dark:text-white animate__animated animate__fadeIn"
            id="el-58esimzj"
          >
            <h2
